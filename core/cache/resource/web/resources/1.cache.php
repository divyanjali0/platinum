<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<div class="hero-wrap ftco-degree-bg" style="background-image: url(\'assets/images/bg_1.jpg\');" data-stellar-background-ratio="0.5">
		  ...
		  <div class="row no-gutters">
			  ...
			  <div class="form-group">
				  ...
				  <input type="text" class="form-control" id="time_pick" placeholder="Time">
					...
					<div class="form-group">
                        <a href="index.php?id=2" class="btn btn-secondary py-3 px-4">Rent A Car Now</a>
                    </div>
