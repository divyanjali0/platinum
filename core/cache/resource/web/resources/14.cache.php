...
',
    ...
    'cacheable' => 1,
    'createdby' => 2,
    'createdon' => 1761715410,
    'editedby' => 2,
    'editedon' => 1761718055,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1756714380,
    'publishedby' => 1,
    'menutitle' => '',
    'content_dispo' => 0,
    'hidemenu' => 0,
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '$pickup = $_SESSION[\'booking\'][\'pickup_location\'] ?? \'\';
...
try {
    $stmt = $conn->prepare("
        SELECT 
            rr.car_category AS name,
            cc.avg_price,
            cc.description,
            cc.image,
            cc.passengers AS no_of_seats,
            cc.suitcases AS luggages
        FROM rental_rates rr
        LEFT JOIN car_categories cc ON cc.name = rr.car_category
        WHERE rr.car_category = ?
        LIMIT 1
    ");
...
return $output;',
          ...
          'static' => false,
          'static_file' => '',
          'content' => '$pickup = $_SESSION[\'booking\'][\'pickup_location\'] ?? \'\';
$dropoff = $_SESSION[\'booking\'][\'dropoff_location\'] ?? \'\';
$pickup_date = $_SESSION[\'booking\'][\'pickup_date\'] ?? \'\';
$pickup_time = $_SESSION[\'booking\'][\'pickup_time\'] ?? \'\';
$dropoff_date = $_SESSION[\'booking\'][\'dropoff_date\'] ?? \'\';
